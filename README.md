...
A multi-tier Capture The Flag competition featuring progressive privilege escalation, real-world attack scenarios, and honeypot traps. Players start with zero access and must hack their way from external attacker → www-data → analyst → engineer → root, collecting 25 flag fragments to assemble the master flag.
...
graph TD
    ...
    T0 --> T0W["T0-Web<br/>WEB-01 – WEB-03<br/>250–300 pts"]
    T0 --> T0C["T0-Crypto<br/>CRYPTO-01 – CRYPTO-02<br/>200–300 pts"]
    T0 --> T0H["T0-Honeypots<br/>5 decoys"]

    T1 --> T1S["T1-Stego<br/>STEGO-01 – STEGO-02<br/>200–350 pts"]
    T1 --> T1F["T1-Forensics<br/>FORENSICS-01 – FORENSICS-02<br/>250–300 pts"]
    T1 --> T1C["T1-Crypto<br/>CRYPTO-03 – CRYPTO-05<br/>200–300 pts"]
    T1 --> T1M["T1-Misc<br/>MISC-01 – MISC-03"]
    T1 --> T1P["T1-PrivEsc<br/>PRIVESC-01 – PRIVESC-02<br/>300–350 pts"]
    T1 --> T1H["T1-Honeypots<br/>8 decoys"]

    T2 --> T2C["T2-Crypto<br/>CRYPTO-06<br/>300 pts"]
    T2 --> T2F["T2-Forensics<br/>FORENSICS-03 – FORENSICS-05<br/>250–300 pts"]
    ...
    T3 --> T3B["T3-Binary<br/>BINARY-02 – BINARY-03<br/>400–500 pts"]
    ...
    T4 --> T4R["T4-RootChallenges<br/>ROOT-01 – ROOT-02<br/>300 pts each"]
...
|--------|------|----------|------------|--------|
| `T0` | 0 | Overview | — | — |
| `T0-Web` | 0 | Web Exploitation | WEB-01 – WEB-03 | 250–300 |
| `T0-Crypto` | 0 | Cryptography | CRYPTO-01 – CRYPTO-02 | 200–300 |
| `T0-Honeypots` | 0 | Decoys | 5 honeypots | -50 penalty |
| `T1` | 1 | Overview | — | — |
| `T1-Stego` | 1 | Steganography | STEGO-01 – STEGO-02 | 200–350 |
| `T1-Forensics` | 1 | Digital Forensics | FORENSICS-01 – FORENSICS-02 | 250–300 |
| `T1-Crypto` | 1 | Cryptography | CRYPTO-03 – CRYPTO-05 | 200–300 |
| `T1-Misc` | 1 | Miscellaneous | MISC-01 – MISC-03 | — |
| `T1-PrivEsc` | 1 | Privilege Escalation | PRIVESC-01 – PRIVESC-02 | 300–350 |
| `T1-Honeypots` | 1 | Decoys | 8 honeypots | -50 penalty |
| `T2` | 2 | Overview | — | — |
| `T2-Crypto` | 2 | Cryptography | CRYPTO-06 | 300 |
| `T2-Forensics` | 2 | Digital Forensics | FORENSICS-03 – FORENSICS-05 | 250–300 |
...
| `T3` | 3 | Overview | — | — |
| `T3-Binary` | 3 | Binary Exploitation | BINARY-02 – BINARY-03 | 400–500 |
...
| `T4` | 4 | Overview | — | — |
| `T4-RootChallenges` | 4 | Root / Final | ROOT-01 – ROOT-02 | 300 |
