...
|---|-----------|----------|--------|------------|------|
| 200 | BINARY-01: Capability Abuse | Binary | 200 | Medium-Hard | `FLAG{t2_c4p_d4c_r34d_4bus3_x7k}` |
| 250 | CRYPTO-06: Encrypted Bash History | Crypto | 250 | Medium | `FLAG{t2_bash_history_aes_d3crypt3d_k7x}` |
| 200 | FORENSICS-03: MySQL Database Extraction | Forensics | 200 | Medium | `FLAG{t2_mysql_dump_3xtr4ct_j9w}` |
| 200 | FORENSICS-04: Systemd Journal Binary | Forensics | 200 | Medium-Hard | `FLAG{t2_j0urn4l_b1n4ry_p4rs3_m2v}` |
| 200 | FORENSICS-05: Kernel dmesg Fragment | Forensics | 200 | Medium | `FLAG{t2_dm3sg_k3rn3l_fr4g_p8n}` |
| 200 | REVERSE-01: License Validator | Reverse | 200 | Hard | `FLAG{t2_r3v3rs3_v4l1d4t0r_q5z}` |
| 200 | SSHKeyHunt: SSH Key Assembly | Multi-part | 200 | Hard | `FLAG{t2_ssh_k3y_4ss3mbl3d_e2r}` |
